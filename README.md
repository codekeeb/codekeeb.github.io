...
El favicon es el monograma C/K en blanco, centrado sobre una baldosa oscura con
esquinas redondeadas (`monogram-tile.png`). Baldosa fija en vez de adaptarse al
tema: así se lee igual de bien en barras claras y oscuras, y la marca es la misma
en todas partes. Los logos de la página son siempre BOW, porque el fondo del
sitio es claro fijo.
...
- [x] Poner la URL real de Etsy en `js/data.js`
